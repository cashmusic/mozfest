...
var pauseMusicMessage = "Press P to pause podcast or T to record yourself";
var playMusicMessage = "Press P to play podcast";
...
function preload() {
  ...
  // musicFile = loadSound('https://s3.amazonaws.com/shareducate02/matt_mazzeo.mp3');
  musicFile = loadSound('skyscraper.mp3');
}
...
function setup() {
    ...
    //
    img = loadImage("https://scontent-b-lhr.xx.fbcdn.net/hphotos-xfa1/v/t1.0-9/215600_3482136700387_1134842005_n.jpg?oh=34bbf52e88ade2466d2d0b6ac8105fcb&oe=54EBB623"); 
...
function draw() {
  ...
  ///
    ...
    // sound quality is terrible so I'm going to try this in non-record mode only:
    if(state!=4){
